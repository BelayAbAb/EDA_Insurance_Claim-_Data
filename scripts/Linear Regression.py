            ...
            if X_test is not None:
                ...
                if X_train.shape[1] > 0:
                    ...
                    plot_feature_importance(feature_importances, feature_names,
                                            r'C:\Users\User\Desktop\10Acadamy\Week-3\Data\MachineLearningRating_v3\feature_importance.jpg')
                else:
                ...
                plt.legend()
                plt.grid(True)
                plt.savefig(r'C:\Users\User\Desktop\10Acadamy\Week-3\Data\MachineLearningRating_v3\linear_regression_results.jpg', format='jpg')
                plt.close()
            else:
                print("X_test is not loaded correctly, cannot make predictions.")
